...
# --- Configuration ---
MD_DIR = "/home/ec2-user/nbs-agentic-rag/data/processed/md"
#MD_DIR = "$HOME/nbs-agentic-rag/data/processed/md"
...
TABLE_NAME = "nbs_doc_md_regular_embedding_rag"
EMBED_DIM = 768
...
def main():
    ...
    # Register Phoenix for tracing
    # Set a project name to group your traces in the Phoenix UI
    tracer_provider = register(project_name="nbs_rag_project_llamaindex-tracing")

    #Instrument LlamaIndex using the LlamaIndexInstrumentor
